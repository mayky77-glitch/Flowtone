...
public struct TempoPlanner: Sendable {
  ...
  private static let profiles: [String: Profile] = [
    ...
    "Light Rave": Profile(common: [124, 128, 132, 136, 140], range: 120...148, surpriseStep: 4),
    "Fantasy": Profile(common: [64, 72, 80, 92, 108], range: 54...126, surpriseStep: 8),
    "Pirate": Profile(common: [84, 96, 108, 120, 132], range: 76...144, surpriseStep: 8),
    "Rock": Profile(common: [96, 108, 120, 132, 144], range: 84...156, surpriseStep: 8),
    ...
    "Industrial Techno": Profile(
      common: [128, 134, 140, 146, 150], range: 126...154, surpriseStep: 2),
    ...
    "Cyberpunk": Profile(common: [92, 112, 128, 144, 168], range: 82...180, surpriseStep: 6),
    "Hip-hop": Profile(common: [62, 72, 82, 92, 100], range: 60...100, surpriseStep: 4),
    "Funk": Profile(common: [88, 96, 104, 112, 118], range: 82...124, surpriseStep: 4),
