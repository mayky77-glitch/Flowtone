...
5. Пользователь выбирает жанровые фильтры, энергию и настроение; все жанры можно выбрать или снять одной командой. Темп подбирается автоматически.
...
- Station setup: жанровые фильтры, энергия, настроение, необязательный vibe prompt и автоматический genre-aware tempo.
