...
5. Пользователь выбирает жанровые фильтры, пресет для каждого жанра, энергию и настроение; все жанры можно выбрать или снять одной командой. Можно включить случайный микс 2–5 активных жанров. Темп подбирается автоматически.
...
- Station setup: 27 жанров, 292 пресета, микс 2–5 жанров, энергия, настроение, необязательный vibe prompt и автоматический genre-aware tempo.
