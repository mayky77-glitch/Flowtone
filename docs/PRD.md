...
5. Пользователь выбирает жанровые фильтры, звуковой профиль жанра, энергию и настроение; все жанры можно выбрать или снять одной командой. Можно включить случайный микс 2–5 активных жанров. Темп подбирается автоматически.
...
- Station setup: 28 жанров, 314 автоматических звуковых профилей, микс 2–5 жанров, энергия, настроение, необязательный vibe prompt и автоматический genre-aware tempo.
...
- Session history, повтор трека, лайк, раздел «Любимые», запуск любого трека из коллекции, экспорт и локальная коллекция.
...
- жанры, выбранные genre preset IDs, energy, tempo, mood, vibe;
...
Как пользователь, я хочу менять жанровые фильтры, энергию, настроение и вайб без остановки музыки; темп должен подстраиваться сам.
